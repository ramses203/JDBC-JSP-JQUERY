...
<div class="add_sub">
	<form action="userupdate" method="post">
		<div class="group">
			<input class="form" type="text" name="id" id="id" value="${vo.id }" readonly="readonly"> 
			<span class="highlight"></span> <span class="bar"></span> <label>아이디</label>
		</div>
		<div class="group">
			<input class="form" type="text" name="pwd" id="pwd" value="${vo.pwd }"> 
			<span class="highlight"></span> <span class="bar"></span> <label>비밀번호</label>
		</div>
		<div class="group">
			<input class="form" type="text" name="uname" id="uname" value="${vo.uname }" readonly="readonly"> 
			<span class="highlight"></span> <span class="bar"></span> <label>이름</label>
		</div>
		<div class="group">      
	     	<input class="form" type="tel" name="phone" id="phone" maxlength="13"  onkeydown="return onlyNumber(event)" onkeyup="removeChar(event)" value="${vo.phone }">
	      ...
	      <label>전화번호</label>
			...
			<input class="posibtn"  type="submit" value="수정">
			<a href="mypageform"><input class="posibtn" type="button" value="돌아가기"></a>
	</form>
</div>
</div>
